...
class GarageB2cPostcode extends AppModel
{

	public $useTable = 'garages_b2c_postcodes';
	...
	{
		if (!empty($oldData)) {
			$this->deleteAll(array('GarageB2cPostcode.postcode_id' => $oldData,'GarageB2cPostcode.garage_id' => $garage_id), false);
		}

		$fields = array(
			'GarageB2cPostcode' => array(
				'garage_id',
				'postcode_id'
			)
		);
			...
			array(
				'joins' => array(
					array(
						...
						'type' => 'Inner',
						'conditions' => array(
							'PostcodeProvince.id = GarageB2cPostcode.postcode_id',
							'GarageB2cPostcode.garage_id' => $garage_id,
						)
					),
				),
				'fields' => array(
