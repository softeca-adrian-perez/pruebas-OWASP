        ...
        var contentString = '' +
            '<div id="map-container">' +
                ...
                '<div class="map-content">' +
                    '<p><strong>Garage: </strong>' + marker.name + '</p>' +
                '</div>' +
            '</div>';
    ...
    var showhide = function () {
        $(".overmap").on('click', 'button', function () {
            if ($(this).hasClass('filled')) {
                ...
                showmarkers($(this).data('net'),false,true);
            } else {
                $(this).removeClass('outlined');
                $(this).addClass('filled');
                showmarkers($(this).data('net'),true,false);
            }
        });
    };

    var showmarkers = function (name,visible,hidden) {
        ...
        markerCluster.setIgnoreHidden(hidden);
        markerCluster.repaint();
    };
