...
<div class="columns medium-12 titulo2 p-0 p-top-1">
                ...
                <div class="d-inline-block cont-services w-100p">
                    ...
                    if(!empty($networks)){
                        foreach ($networks as $key_network => $network) {
                            ?>
                            <div class="medium-2 columns end <?php if ($key_network % 6 == 0) { echo "clear"; } ?>">
                                <label>
                                    <?php
                                    $valor = false;
            ...
            <div class="columns medium-12 p-left-1 clear end">
                ...
                echo $this->Form->input(
                    ...
                    array(
                        ...
                        'checked' => ($action == 'add_subsection') ? true : $section_subsection['SectionSubsection']['without_networks']
                    )
                ); ?>
                </div>
            </div>
                ...
                <?php
                    if(!empty($distributors_networks)){
                        foreach ($distributors_networks as $key_distributor_network => $distributor_networks) {
                            ?>
                            <div class="medium-2 columns end <?php if ($key_distributor_network % 6 == 0) { echo "clear"; } ?>">
                                <label>
                                    <?php
                                    $valor = false;
                                    if ($action == 'edit_subsection') {
                ...
                <div class="columns medium-12 p-left-1 clear end">
                    ...
                    echo $this->Form->input(
                        ...
                        array(
                            ...
                            'checked' => ($action == 'add_subsection') ? true : $section_subsection['SectionSubsection']['without_distributor_networks']
                        )
                    ); ?>
                </div>
            </div>
                ...
                <div class="d-inline-block cont-services w-100p">
                    ...
                    if(!empty($trading_groups)){
                        foreach ($trading_groups as $key_trading_group => $trading_group) {
                            ?>
                            <div class="medium-2 columns end <?php if ($key_trading_group % 6 == 0) {
                                echo "clear";
                            } ?>">
                                <label>
                                    <?php
        ...
        <div class="columns medium-12 p-form">
            ...
            <div class="columns medium-12 clear end">
                <div class="columns medium-3 p-left-0 end">
                    <?php 
                    echo $this->Form->input(
                        'aag_member_yes',
                        array(
                            ...
                            'checked' => ($action == 'add_subsection') ? true : $section_subsection['SectionSubsection']['aag_member_yes']
                        )
                    ); ?>
                </div>
                <div class="columns medium-3 p-left-0 end">
                    ...
                    echo $this->Form->input(
                        ...
                        array(
                            ...
                            'type' => 'checkbox',
                            'id' => 'is_aag_member_no',
                            'checked' => ($action == 'add_subsection') ? true : $section_subsection['SectionSubsection']['aag_member_no']
                        )
                    ); ?>
                </div>
            </div>
