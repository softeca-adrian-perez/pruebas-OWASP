<?php
echo $this->Html->script('resume.js?v=' . Configure::read('VERSION_CACHE'), array('block' => 'script'));
...
<div class="cnt-data aag-padding">
    ...
    <div class="row" style="padding-top: 67px;" data-equalizer>
                ...
                <div class="columns medium-12">
                    <div class="columns medium-6 p-1 ta-right">
                        ...
                        <div class="border_bottom_blue" style="min-height: 25px;">
                            <strong>
                                <?php echo (isset($garage_appointment_next['Appointment'])) ? Fecha::toFormatoVistaFecha(h($garage_appointment_next['Appointment']['date'])) : null;?>
                            </strong>
                        </div>
                    </div>
                    <div class="columns medium-6 p-1  ta-right">
                        ...
                        <div class="border_bottom_blue" style="min-height: 25px;">
                            <?php echo ($garage['Garage']['last_visit']) ? Fecha::toFormatoVistaFecha(h($garage['Garage']['last_visit'])) : null;?>
                        </div>
                    </div>
                </div>
            </div>
