...
<div class="cnt-data aag-padding">
    ...
    <div class="clear cnt-form-animate">
        <?php echo $this->element('../Clients/Elements/search_tracking_task', array('param' => $garage['Garage']['id'])); ?>
    </div>
    <div class="o-auto">
        <table class="table-tracking">
            ...
            foreach( $tasks as $key => $task )
            {
                ...
                <tr>
                    ...
                    <td class="ta-center">
                        <div>
                            <?php echo Fecha::toFormatoVistaFecha(h($task['TaskGarage']['completed_date'])); ?>
                        </div>
                    </td>
                    <td class="ta-center">
                        <div>
                            ...
                            echo $this->Form->hidden(
                                ...
                                array(
                                    ...
                                    'data-garage-id' => $task['TaskGarage']['garage_id'],
                                    'data-url' => Router::url(
                                        array(
                                            'controller' => 'tasks',
