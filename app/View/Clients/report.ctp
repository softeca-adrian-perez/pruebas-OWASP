    ...
    <div class="cnt-data aag-padding">
            ...
            ?>
                        <div class="d-inline-block ta-center end p-right-1 item-logo m-top-1">
                            <div>
                                <?php
                                if (
                                    $network['Network']['id'] == NETWORK_ID_AGN && ($user_role == ConstantsRoles::ADMIN || $user_role == ConstantsRoles::SUPER_ADMIN || $user_role == ConstantsRoles::GARAGE || $user_role == ConstantsRoles::BDM_AAG || $user_role == ConstantsRoles::BDM_TG || $user_role == ConstantsRoles::GARAGE_NETWORK_MANAGER)
                                    && $garage_network['GarageNetwork']['status'] == ConstantsNetworksStatus::LIVE && $garage['Garage']['status'] == ConstantsGarageStatus::ACTIVE
                                ) {
                                    echo $this->Html->link(
                                        '<img class="logotipo" title="' . h($network['Network']['name']) . '" src="' . FileManager::get_url(FilePaths::NETWORKS_IMAGES_RELATIVE . h($network['Network']['image'])) . '" />',
                                        array(
                                ...
                                ?>
                                    <img class="logotipo" title="<?php echo h($network['Network']['name']); ?>" src="<?php echo FileManager::get_url(FilePaths::NETWORKS_IMAGES_RELATIVE . h($network['Network']['image'])); ?>" />
                                <?php } ?>
                            </div>
                            <div>
                                <?php
        ...
        <div class="row">
            <div class="columns medium-9">
                <span><b class="fs-small"><?php echo __t('Garage.Creation_date'); ?> </b> <?php echo ': ' . Fecha::toFormatoVista(h($garage['Garage']['creation_date'])); ?></span>
                <span class="p-left-1"><?php echo ''; ?></span>
                <span><b class="fs-small"><?php echo __t('Garage.Modification_date'); ?> </b><?php echo ': ' . Fecha::toFormatoVista(h($garage['Garage']['modification_date'])); ?></span>
            </div>
            <br />
            <br />
            <ul class="aag-subtabs clear m-bottom-1">
                ...
                <?php if ($config[ConstantsConfig::EQUIPMENT] && !empty($garage_equipments)) { ?>
                    <li><a href="#equipment_anchor"><?php echo __t('Equipment.Equipment') ?></a></li>
                <?php
                }
                if (!empty($garage_software)) {
                ?>
                    <li><a href="#software_anchor"><?php echo __t('Garage.Software') ?></a></li>
                <?php
                }
                if (!empty($garage_websites) || $config[ConstantsConfig::LEAD_SOURCE] || $config[ConstantsConfig::INTEREST] || $config[ConstantsConfig::MARKETING_EMAIL]) {
                ?>
                    <li><a href="#marketing_anchor"><?php echo __t('Garage.Marketing') ?></a></li>
                <?php
                }
                if (!empty($garage_comments)) {
                ?>
                ...
                if (!empty($garages_networks)) {
                ?>
                    <li><a href="#trainings_credits"><?php echo __t('Training.Trainings_credits') ?></a></li>
                <?php } ?>
            </ul>
        </div>
        <div class="row p-bottom-1">
            <div class="columns medium-8 p-0">
                <div class="cnt-form-inputs">
                    ...
                    <div>
                        <strong><?php echo __t('Fax') ?>:</strong>
                        <br>
                        <div class="b-bottom-1 height_input"><?php echo h($garage['Garage']['fax']); ?> </div>
                    </div>
                    <div class="column-clear">
                        <div>
                            <strong><?php echo __t('Garage.24h_phone') ?>:</strong>
                            <br>
                    ...
                    <div>
                        <strong><?php echo __t('Garage.Email') ?>:</strong>
                        <br>
                        <div class="b-bottom-1 height_input">
                    ...
                    <div>
                        <strong><?php echo __t('Garage.Web') ?>:</strong>
                        <br>
                        <div class="b-bottom-1 height_input">
                            <a target="_blank" title="<?php echo h($garage['Garage']['web']); ?>" href="<?php echo h($garage['Garage']['web']); ?>"><?php echo h($garage['Garage']['web']); ?></a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="columns medium-4">
                <div class="ta-center" style="height: 214px;">
                    <?php if (!isset($garage_principal_image['GarageImage']) || $garage_principal_image['GarageImage']['file'] == "") { ?>
        ...
        <div class="cnt-form-inputs">
            ...
            <div>
                ...
                <div class="b-bottom-1 height_input">
                    <?php
                    if ($garage['Garage']['visit_monday']) {
                        echo __t('Garage.Monday');
                    }
                    if ($garage['Garage']['visit_tuesday']) {
                        echo __t('Garage.Tuesday');
                    }
                    if ($garage['Garage']['visit_wednesday']) {
                        echo __t('Garage.Wednesday');
                    }
                    if ($garage['Garage']['visit_thursday']) {
                        echo __t('Garage.Thursday');
                    }
                    if ($garage['Garage']['visit_friday']) {
        ...
        <div class="m-top-1">
            <span class="fields_views wrd_label m-top-1" style="margin-left:0px;"><?php echo __t('Distributor.Workshop_activities'); ?></span>
            <div class="columns medium-12 p-horizontal-0 b-bottom-1 height_input">
                <?php
                foreach ($workshop_activities_garage as $workshop_activity_garage) {
                        ...
                        <tbody>
                            <?php foreach ($garage_internal_networks as $garage_network) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                        if ($garage_network['GarageNetwork']['network_contract_type_id']) {
        ...
        if (!empty($garage_internal_agreements) || !empty($garage_external_agreements)) {
        ?>
            <div class="row">
                <div>
                    <div class="anchor_nav aag-subtitle" id="network_anchor"> <?php echo __t('General.Agreements') ?></div>
                </div>
                <div class="o-auto p-bottom-1">
                    <table class="table-tracking table-responsive z-index-priority">
                        <thead>
                        ...
                        <tbody>
                            <?php foreach ($garage_internal_agreements as $internal_agreement) { ?>
                                <tr>
                                    <td>
                                        <?php echo h($internal_agreement['GaAcuerdo']['fleet_agreement']); ?>
                                    </td>
                                    <td>
                    ...
                    <table class="table-tracking table-responsive z-index-priority">
                        ...
                        <tbody>
                            <?php foreach ($garage_external_agreements as $external_agreement) { ?>
                                <tr>
                                    <td>
                                        <?php echo h($external_agreement['Agreement']['nombre']); ?>
                                    </td>
                                    <td>
        ...
        <div class="row">
            <div class="anchor_nav aag-subtitle" id="location_anchor"> <?php echo __t('Garage.Membership_fees') ?></div>
                ...
                <div class="row">
                    <div class="cnt-form-inputs p-bottom-1">
                        <div>
                            <strong>
                                <?php
                                $msg = isset($country['Country']['symbol']) ? __t('Garage.Current_charge') . ' ' . $country['Country']['symbol'] : __t('Garage.Current_charge');
                                echo $msg;
                                ?>:
                            </strong>
                            <br>
                            <div class="b-bottom-1 height_input">
                                <?php
                                if (isset($garage_network['GarageNetwork']['current_charge'])) {
                                    echo $garage_network['GarageNetwork']['current_charge'];
                                } else {
                                    echo "0";
                                }
                                ?>
                        ...
                        <div>
                            <strong><?php echo __t('Garage.Member_pays') ?>:</strong>
                            <br>
                            <div class="b-bottom-1 height_input">
                                <?php
                                if (isset($garage_network['GarageNetwork']['member_pays'])) {
                                    echo $garage_network['GarageNetwork']['member_pays'];
                                } else {
                                    echo "0";
                                }
                                ?>
                        ...
                        <div>
                            <strong><?php echo __t('Garage.Garage_pays') ?>:</strong>
                            <br>
                            <div class="b-bottom-1 height_input">
                                <?php
                                if (isset($garage_network['GarageNetwork']['garage_pays'])) {
                                    echo h($garage_network['GarageNetwork']['garage_pays']);
                                } else {
                                    echo "0";
                                }
                                ?>
            ...
            <div class="row">
                ...
                <div class="o-auto p-bottom-1">
                    <table class="table-tracking table-responsive z-index-priority tabla-limitada">
                        ...
                        <tbody>
                            <?php foreach ($garage_contacts_general_branch_manager as $contact_general_branch_manager) { ?>
                                <tr>
                                    <td>
            ...
            <div class="row">
                ...
                <div class="o-auto p-bottom-1">
                    <table class="table-tracking table-responsive z-index-priority tabla-limitada">
                        ...
                        <tbody>
                            <?php foreach ($garage_contacts_bdm as $contact_bdm) { ?>
                                <tr>
                                    <td>
        ...
        <div class="row">
            ...
            <div class="columns medium-8 p-0">
                <div class="cnt-form-inputs p-bottom-1">
                    ...
                    <div>
                        <strong><?php echo __t('Garage.Address_2') ?>:</strong>
                        <br>
                        <div class="b-bottom-1 height_input">
                            <?php echo h($garage['Garage']['address2']); ?>
                        </div>
                    </div>
                    <div>
                        <strong><?php echo __t('Garage.Address_3') ?>:</strong>
                        <br>
                        <div class="b-bottom-1 height_input">
                            <?php echo h($garage['Garage']['address3']); ?>
                        </div>
                    </div>
                    <div>
                        <strong><?php echo __t('Garage.Address_4') ?>:</strong>
                        <br>
                        <div class="b-bottom-1 height_input">
                            <?php echo h($garage['Garage']['address4']); ?>
                        </div>
                    </div>
                    <div>
                    ...
                    <div>
                        <strong><?php echo __t('Garage.Sales_area') ?>:</strong>
                        <br>
                        <div class="b-bottom-1 height_input">
                            <?php echo (isset($garage['Garage']['sales_area_id']) && isset($sales_area[$garage['Garage']['sales_area_id']])) ? h($sales_area[$garage['Garage']['sales_area_id']]) : ''; ?>
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="o-auto p-bottom-1">
                    <table class="table-tracking">
                        ...
                        <tbody>
                            <?php foreach ($garage_activities as $garage_activity) { ?>
                                <tr>
                                    <td>
        ...
        ?>
            <div class="row">
                ...
                <div class="columns medium-12">
                    <fieldset class="fieldset-garage-list cnt-estilo-nuevo z-index-priority">
                        <div class="d-inline-block cont-services w-100p">
                            <?php
                            foreach ($services as $service) {
                                foreach ($garage_services as $garage_service) {
                                    if (isset($garage_service) && $service['Service']['id'] == $garage_service['GarageService']['service_id']) {
                            ?>
                        ...
                        <div class="d-inline-block cont-services w-100p">
                            ...
                            foreach ($vehicle_types as $vehicle_type) {
                                foreach ($garage_vehicle_types as $garage_vehicle_type) {
                                    if (isset($garage_vehicle_type) && $vehicle_type['VehicleType']['id'] == $garage_vehicle_type['GarageVehicleType']['vehicle_type_id']) {
                            ?>
                                        <div class="medium-2 columns end">
                                            <label class="cursor-default">
                                                <span>
                        ...
                        <div class="d-inline-block cont-services w-100p">
                            ...
                            foreach ($vehicles as $vehicle) {
                                ...
                                foreach ($garage_vehicles as $garage_vehicle) {
                                    if (isset($garage_vehicle) && $vehicle['Vehicle']['id'] == $garage_vehicle['Vehicle']['id']) {
                                        $active = true;
                                    }
                                }
                                foreach ($garage_vehicle_specialists as $garage_vehicle_specialist) {
                                    if (isset($garage_vehicle) && $vehicle['Vehicle']['id'] == $garage_vehicle_specialist['GarageSpecialistMake']['vehicle_id']) {
                                        $icon = 'ion-ios-star';
                                    }
                                }
                                if ($active == true) {
                            ...
                            <div class="d-inline-block cont-services w-100p">
                                ...
                                foreach ($parts_brands as $part_brand) {
                                    ...
                                    foreach ($garages_parts_brands as $garages_part_brand) {
                                        if (isset($garages_part_brand) && $part_brand['Brand']['id'] == $garages_part_brand['Brand']['id']) {
                                            $active = true;
                                        }
                                    }
        ...
        <?php
        if ($config[ConstantsConfig::EQUIPMENT]) {
            if (!empty($garage_equipments)) {
        ?>
                <div class="row">
            ...
            <div class="row">
                ...
                <div class="o-auto p-bottom-1">
                    <table class="table-tracking table-responsive">
                        ...
                        <tbody>
                            <?php foreach ($garage_comments as $comment) { ?>
                                <tr>
                                    <td>
        ...
        ?>
            <div class="row">
                <div class="anchor_nav aag-subtitle" id="log_changes_anchor"><?php echo __t('Garage.Log_changes') ?>
                    <?php
...
<?php
    ...
    } elseif (isset($status) && $status == ConstantsGarageStatusDe::POTENTIAL) {
?>
<div class="row p-top-1">
    <div class="columns medium-8">
        <div class="columns medium-6 title-big p-0">
            <?php echo h($garage['Garage']['name']) . ' - ' . __t('General.Gnm_id') . ' : ' . $this->request['pass'][0]; ?>
        </div>
    </div>
    <div class="columns medium-4 ta-right p-1">
        <?php
        echo $this->Html->link(
            __t('General.Back'),
            array(
    ...
    <div class="row p-1" data-equalizer>
        <div class="columns medium-8 m-top-1" data-equalizer-watch>
            <fieldset class="columns fieldset-garage-list cnt-estilo-nuevo">
                <div class="row">
                    ...
                    <div class="columns medium-6 p-1 end">
                        <strong><?php echo __t('Garage.Status') ?>: </strong>
                        <br>
                        <div class="b-bottom-1 height_input">
                            <strong class="c-informacion">
                                <?php echo h($garage_statuses_de[$garage['Garage']['status']]); ?>
                            </strong>
                        </div>
                    </div>
                    <div class="columns medium-6 p-1 end">
                        <strong><?php echo __t('Garage.Contact_list') ?>: </strong>
                        <?php
                        echo $this->Form->input(
                            ...
                            array(
                                ...
                                'default' => $garage['GarageContactList']['contact_list_id'],
                                'disabled' => true,
                                'empty' => true,
                            )
                        );
        ...
        <div class="columns medium-4 m-top-1" data-equalizer-watch>
            <div class="columns medium-12 background-color-primary ta-center">
                <?php if (empty($garage_images)) { ?>
                    <div class="medium-12 columns p-1">
                        <img src="<?php echo '/img/default.png' ?>">
                    </div>
                    <?php
                } else {
                    foreach ($garage_images as $key => $image) {
                    ?>
                        <div class="medium-12 columns p-1">
                            <?php
                            echo $this->Html->image(
...
?>
    <div class="cnt-data aag-padding">
        <div class="row p-bottom-1">
            <div>
                <div class="anchor_nav aag-subtitle" id="trainings_credits"> <?php echo __t('Training.Trainings_credits') ?></div>
            </div>
            <div>
                ...
                <table id="training_table" class="table-tracking">
                    <thead>
                        <tr>
                            ...
                            <th><?php echo __t('Training.Default_credits') ?></th>
                            <th><?php echo __t('Conference.Start_date') ?></th>
                            <th><?php echo __t('Software.End_date') ?></th>
                            ...
                            <th><?php echo __t('Allowance.Actual_allowance') ?></th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
                        ...
                        ?>
                                <tr class="<?php echo $tableAllowanceClass; ?>">
                                    ...
                                    <td class="color-blue-text">
                                        <strong><?php echo ($sums_given_list[$garage_network['TrainingAllowance']['id']] ?? '0') . ' ' . $this->Html->image(FileManager::get_url(FilePaths::ICONS_IMAGES_RELATIVE . 'cr.svg')) ?></strong>
                                    </td>
                                    <td class="color-blue-sky">
                                        <strong><?php echo ($sums_spent_list[$garage_network['TrainingAllowance']['id']] ?? '0') . ' ' . $this->Html->image(FileManager::get_url(FilePaths::ICONS_IMAGES_RELATIVE . 'cr.svg')); ?></strong>
                                    </td>
                                    <td class="color-blue-text">
                                        <strong>
                                            <?php
                                            ...
                                            echo $total_points . $this->Html->image(FileManager::get_url(FilePaths::ICONS_IMAGES_RELATIVE . 'cr.svg'));
                                            ?>
                                        </strong>
                                    </td>
                                    <td>
