...
<div class="cnt-form-inputs">
    ...
    <label class="center-check p-top-1">
        ...
        <div class="aag-switch round small">
            <?php echo $this->Form->input('requires_follow_up', array('id' => 'followUp', 'label' => false, 'div' => false, 'class' => 'unselectable clear_field', 'type' => 'checkbox', 'required' => true)); ?>
