...
echo $this->Form->create(
    ...
    <div class="cnt-form-search-title">
        <?php echo __t('Training.Courses_list'); ?>
    </div>
    <div class="cnt-form-inputs">
        ...
        echo $this->Form->input(
            ...
            array(
                'label' => __t('Training.Status_planned_course'),
                'type' => 'select',
                'class' => 'select2-multiple clear_field',
                'options' => $status_list,
                'empty' => true,
        ...
        <div class="p-top-1">
            <?php echo $this->Form->input(
                ...
                array(
                    ...
                    'type' => 'range',
                    'required' => true,
                    'label' => __t('Training.Cost_of_training'),
        ...
        <div class="cnt-check-visit cnt-form-inputs-max-width">
            <label class="center-check ">
                <?php echo __t('Training.Status_course'); ?>
