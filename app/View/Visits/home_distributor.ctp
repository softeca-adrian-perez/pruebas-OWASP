...
echo $this->Html->script('gmaps_visits_distributors.js?v=' . Configure::read('VERSION_CACHE'), array('block' => 'script'));
echo $this->Html->script('visits_distributors.js?v=' . Configure::read('VERSION_CACHE'), array('block' => 'script'));
...
echo $this->Form->hidden(
    '',
    array(
        'id' => 'ajax_get_data_distributor',
        'data-url' => Router::url(
            array(
                'controller' => 'visits',
                'action' => 'ajax_get_data_distributor'
            )
        )
    )
);
...
<div class="cnt-data aag-padding position-relative">
    <div class="aag-title">
        <?php echo __t('Menu.Planning_visits'); ?>: <?php echo __t('Distributor.Distributors'); ?>
    </div>
    <div class="row">
        <div class="aag-subtitle p-top-1">
            <?php echo __t('General.Search_planning_visit_1'); ?>
        </div>
        <?php echo $this->element('../Visits/Elements/search_distributors') ?>
    </div>
    ...
    <div class="columns medium-12" id="search_results" style="margin-bottom:80px">
        <div class="medium-12 columns background-color-primary p-1 fieldset_visit">
            ...
            <div id="results_table_container">
                <?php echo $this->element('../Visits/Elements/results_table_distributors'); ?>
            </div>
            <div class="ta-right d-inline-block w-100p clear p-top-1">
                <?php echo $this->Html->link(
                    "<span class='ion-ios-plus-outline'></span>" .  __t('Visit.Add_selected_distributors'),
                    'javascript:void(0)',
                    array(
                        'escape' => false,
                        'id' => 'add_distributor',
    ...
    <div class="o-auto">
        <table class="table-tracking">
            ...
            <tbody id="table-added-distributors"></tbody>
        </table>
    </div>

    <div class="f-right ta-right cnt-blue-red">
        <?php
        echo $this->Html->link(
            ...
            array(
                ...
                'data-type' => ConstantsVisitType::DISTRIBUTOR,
                'data-url' => Router::url(
                    array(
                        'controller' => 'routes',
                        'action' => 'ajax_create_route_distributor'
                    )
                )
            )
        );
        ...
        echo $this->Html->link(
            ...
            array(
                ...
                'data-url' => Router::url(
                    array(
                        'controller' => 'routes',
                        'action' => 'ajax_edit_route_distributor'
                    )
                )
            )
        );
        ...
        echo $this->Html->link(
            ...
            array(
                ...
                'data-url' => Router::url(
                    array(
                        'controller' => 'visits',
                        'action' => 'generate_visits_distributors'
                    )
                )
            )
        );
        echo $this->Html->link(
            ...
            array(
                ...
                'data-count-users' => count($contacts_bdm),
            ...
            array(
                ...
                'data-url' => Router::url(
                    array(
                        ...
                        'action' => 'ajax_distributor_excel_planing_visit',
                        $controller
                    )
                ),
            )
        ...
        echo $this->Html->link(
            __t('Visit.Delete_all_distributors_added'),
            'javascript:void(0)',
            array(
                'escape' => false,
                'id' => 'delete_all_distributors_added',
                'title' => __t('Visit.Delete_all_distributors_added'),
