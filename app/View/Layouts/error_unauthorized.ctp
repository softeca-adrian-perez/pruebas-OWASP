...
<div class="cnt-no-encontrado">
    <div>
        <div>
            <?php echo strtoupper(__t('General.Unauthorized')); ?>
            <strong>
                401
            </strong>
            <div>
                <div>
                    <?php echo strtoupper(__t('General.Sorry_you_are_not_authorized_to_access_this_page')); ?>
                </div>
                <span>
                    <?php echo strtoupper(__t('General.Oops_you_may_not_have_the_necessary_permissions')); ?>
                </span>
