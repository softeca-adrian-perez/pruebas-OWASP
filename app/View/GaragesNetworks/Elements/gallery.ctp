...
echo $this->Html->script('gallery.js?v='.Configure::read('VERSION_CACHE'), array('block' => 'script'));
?>
                ...
                <?php
                    ...
                    foreach ($images as $image) {
                        ...
                        <li class="garages_images_carousel orbit-slide">
                            ...
                            <?php
                            if( $controller == 'garages_networks')
                            {
                                ?>
                                <div class="orbit-caption">
                                    <?php
                                    echo $image['GarageNetworkImage']['file'].' ';
                                    if($image['GarageNetworkImage']['principal'] ==  ConstantsBooleans::NO)
                                    {
                                        echo $this->Html->link(
                                            ...
                                            array(
                                                ...
                                                'data-id' => $image['GarageNetworkImage']['id'],
