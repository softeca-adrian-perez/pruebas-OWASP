...
<div class="cnt-data aag-padding">
    ...
    <div class="d-inline-block cnt-items-logo">
        ...
        ?>
                    <div class="d-inline-block ta-center end p-right-1 item-logo m-top-1">
                        <div>
                            <img style="height: 40px !important" class="logotipo" title="<?php echo h($network['DistributorNetwork']['name']); ?>" src="<?php echo FileManager::get_url(FilePaths::NETWORKS_IMAGES_RELATIVE . $network['DistributorNetwork']['image']); ?>" />
                        </div>
                        <div>
                            <?php
    ...
    <div class="row">
        <div class="columns medium-9">
            <span><b><?php echo __t('Distributor.Creation_date') ?> </b> <?php echo ': ' . Fecha::toFormatoVista(h($distributor['Distributor']['creation_date'])); ?></span>
            <span class="p-left-1"><?php echo (''); ?></span>
            <span><b><?php echo __t('Distributor.Modification_date') ?> </b> <?php echo ': ' . Fecha::toFormatoVista(h($distributor['Distributor']['modification_date'])); ?></span>
            <span>
        ...
        <?php if (
            in_array(CakeSession::read('Auth.User.role_id'), array(ConstantsRoles::GPC_LOGISTICS_DIRECTOR, ConstantsRoles::GPC_LOGISTICS_RM)) ||
            (
                CakeSession::read('Auth.User.role_id') == ConstantsRoles::TG_DIRECTOR &&
                CakeSession::read('Auth.User.Contact.position_id') == ConstantsPositions::TRADING_GROUP_DIRECTOR_ID
            )
        ) {
        ?>
            <div class="columns medium-3 ta-right">
        ...
        <ul class="aag-subtabs clear m-bottom-1">
            ...
            <?php if ($config[ConstantsConfig::LABEL]) { ?>
                <?php if (!empty($distributor_labels)) { ?>
                    <li><a href="#label_anchor"><?php echo __t('Label.Label') ?></a></li>
                <?php } ?>
            <?php } ?>
            <?php if ($config[ConstantsConfig::AAG_SERVICES]) { ?>
                <?php if (!empty($distributor_services)) { ?>
                    <li><a href="#service_anchor"><?php echo __t('Distributor.Aag_services') ?></a></li>
                <?php } ?>
            <?php } ?>
            <?php if (!empty($distributor_software)) { ?>
                <li><a href="#software_anchor"><?php echo __t('Distributor.Software') ?></a></li>
            <?php } ?>
            <?php if (!empty($distributor_contracts)) { ?>
            ...
            <?php } ?>
            <?php if (!empty($distributor_contacts_bdm)) { ?>
                <li><a href="#bdm_anchor"><?php echo __t('Contact.BDM') ?></a></li>
            <?php } ?>
            <?php if (!empty($distributor_contacts_staff)) { ?>
                <li><a href="#staff_anchor"><?php echo __t('Contact.Staff') ?></a></li>
            <?php } ?>
            <?php if (!empty($distributor_comments)) { ?>
        ...
        <div class="columns medium-8 p-0">
            <div class="cnt-form-inputs">
                ...
                <div>
                    ...
                    <div class="b-bottom-1 height_input">
                        <?php
                        $tradingGroupName = isset($trading_groups[$distributor['Distributor']['trading_group_id']]) ? h($trading_groups[$distributor['Distributor']['trading_group_id']]) : null;
                        echo $tradingGroupName;
                        ?>
                    </div>
                </div>
                ...
                <?php } ?>
                <?php if ($config[ConstantsConfig::CREDIT_WATCH]) { ?>
                    <div>
                ...
                <div>
                    ...
                    <div class="b-bottom-1 height_input">
                        <?php
                        if ($distributor['Distributor']['status']) {
                            echo h($distributor_statuses[$distributor['Distributor']['status']]);
                        }
                        ?>
                    </div>
                </div>
