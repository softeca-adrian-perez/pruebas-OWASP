...
class MpdfComponent extends Component {
	...
	public function shutdown(Controller $controller) {
        ...
        if ($this->_obtener_pdf_como_texto) {
            $this->pdf->WriteHTML((string)$controller->response);
            $controller->response->body($this->pdf->Output('', 'S'));
        }
	}

    protected $_obtener_pdf_como_texto = false;

    public function obtener_pdf_como_texto() {
        $this->_init = false;
        $this->_obtener_pdf_como_texto = true;
    }
